<template>
  <div>
    <header_ />
    <div class="condition">
      <p v-if="shop_data.goods_status==6">{{shop_data.title}}订单追加评价</p>
      <p v-if="shop_data.goods_status==3">{{shop_data.title}}订单评价</p>
      ...
      <div class="order_des">
        <div v-if="shop_data.order_type=='2'">
          <p>
            {{shop_data.title}}：
            <span class="red">￥{{shop_data.total_sum}}</span>
          </p>
          <p>{{shop_data.title}}每平米单价：<span>{{shop_data.price}}</span></p>
        </div>
        <div v-if="shop_data.order_type=='4'">
          <p>
            设计费：
            <span class="red">￥{{shop_data.total_sum}}</span>
          </p>
          <p>
            设计师：
            <span>{{design_user_info.xing}}{{design_user_info.name}}</span>
          </p>
          <p>
            <span>设计师手机号：</span>
            <span>{{quantity_room_info.mobile}}</span>
          </p>
          <p>每平米设计费：<span>{{shop_data.price}}</span></p>
        </div>
        <div v-if="shop_data.order_type=='3'">
          <p>
            施工费：
            <span class="red">￥{{shop_data.total_sum}}</span>
          </p>
          ...
          <p>每平米施工费：<span>{{shop_data.price}}</span></p>
        </div>
        <div>房屋面积：{{quantity_room_info.room_area}}平米</div>
        <div>房屋地址：{{shop_data.room_address_detail}}</div>
      </div>
      <div class="assess" v-if="shop_data.goods_status==3">
        <p>评价内容：</p>
      ...
      <div class="img_star" v-if="shop_data.goods_status==3&&shop_data.order_type==3">
        <p>
          <span>施工质量：</span>
          <img
      ...
      <div class="img_star" v-if="shop_data.goods_status==3&&shop_data.order_type==4">
        <p>
          <span>设计效果：</span>
          <img
            @click="zhiliang_tap(index)"
      ...
      <div class="img_star" v-if="shop_data.goods_status==3&&shop_data.order_type==2">
        <p>
          <span>设计效果：</span>
          <img
            @click="zhiliang_tap(index)"
      ...
      <div class="pics" v-if="shop_data.goods_status==3">
        <p>添加图片：</p>
        <ul>
      ...
      <div v-if="shop_data.goods_status==3" class="btn" @click="btn_tap">提交</div>
  ...
  created() {
    ...
    request({
      ...
      if (data.data.status == 200) {
        ...
        this.design_user_info = data.data.data.design_user_info

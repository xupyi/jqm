<template>
  <div class="info">
    ...
    <ul>
      <router-link
        tag="li"
        :to="{path:'supper_detail',query: { user_type:'constructor'}}"
      >
        <span>修改施工长个人资料</span>
      ...
      <router-link
        tag="li"
        :to="{path:'/personal/constructor_await_order',query: { status:1}}"
      >
        <span>待施工订单</span>
        <img src="../../../assets/home_img/you.png" alt />
      </router-link>
      <router-link
        tag="li"
        :to="{path:'/personal/constructor_await_order',query: { status:2}}"
      >
        <span>在施工订单</span>
        <img src="../../../assets/home_img/you.png" alt />
      </router-link>
      <router-link
        tag="li"
        :to="{path:'/personal/constructor_await_order',query: { status:3}}"
      >
        <span>已确认订单</span>
        <img src="../../../assets/home_img/you.png" alt />
      </router-link>
      <router-link
        tag="li"
        :to="{path:'/personal/constructor_await_order',query: { status:4}}"
      >
        <span>已结算订单</span>
        <img src="../../../assets/home_img/you.png" alt />
      </router-link>

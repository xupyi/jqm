<template>
  <div class="info">
    ...
    <ul>
      <router-link
        tag="li"
        :to="{path:'/personal/salesman_await_order',query: { status:1}}"
      >
        <span>在处理订单</span>
      ...
      <router-link
        tag="li"
        :to="{path:'/personal/salesman_await_order',query: { status:3}}"
      >
        <span>已确认订单</span>
        <img src="../../../assets/home_img/you.png" alt />
      </router-link>
      <router-link
        tag="li"
        :to="{path:'/personal/salesman_await_order',query: { status:4}}"
      >
        <span>已结算订单</span>
        <img src="../../../assets/home_img/you.png" alt />
      </router-link>
